...
Summer is a Python-based framework for the creation and execution of `compartmental models <https://en.wikipedia.org/wiki/Compartmental_models_in_epidemiology>`_ (or "state-based") epidemiological models of infectious disease transmission.
