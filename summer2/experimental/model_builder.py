...
def parameter_class(constraint_func=is_real, desc: str = None, full_desc: str = None):
    ...
    class ConcreteFloatParameter(ConcreteParameter):
        ...
        def __init__(self, value):
            ...
            self.value = self.type_validator(value)
...
def parameter_array_class(constraint_func=is_real, desc: str = None, full_desc: str = None):
    ...
    class ConcreteArrayParameter(ConcreteParameter):

        constraint = constraint_func
        description = _desc
        full_description = _full_desc
        type_validator = np.array
