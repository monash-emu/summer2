...
def sir(times=[0, 100]):
    ...
    m.add_infection_frequency_flow("infection", param("contact_rate", 0.4), "S", "I")
    m.add_transition_flow("recovery", param("recovery_rate", 0.1), "I", "R")
    incidence = m.request_output_for_flow("incidence", "infection")
    m.request_function_output("notifications", incidence * param("cdr", 0.2))
